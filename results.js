  ...
  },
  {
    ...
    weights: [
      ...
      { wt: 87, placements: [
        ...
        "3rd Vince Pietragallo (Mt. Lebanon) F Colt Knapp (Plum), 0:54",
      ...
      { wt: 108, placements: [
        "1st Dom Cadwaller (Thomas Jefferson) MD Ziyon Smallss (The Neighborhood Academy), 20-7",
      ...
      { wt: 115, placements: [
        "1st Kaden Fitz (Thomas Jefferson) F Lucas Guzek (South Park), 3:58",
        "3rd Cole Tunstall (Shaler Area) F John Kail (Mt. Lebanon), 1:52",
        "5th Colter Sidick (Shaler Area) FOR Luke Krushinski (Fox Chapel)",
      ]},
      { wt: 122, placements: [
        "1st Shaun Murphy (North Hills) F Thomas Naviglia (Highlands), 2:13",
        "3rd Robert Cordova (Thomas Jefferson) F Lashawn Haley (West Mifflin), 1:46",
        "5th Logan Krul (Avonworth) F Joel Kline (Plum), 0:45",
      ]},
      { wt: 130, placements: [
        "1st Bryce Tavarez (Highlands) F Lucas Skerbertz (Bethel Park), 1:09",
        "3rd Weston Emmons (Shaler Area) DEC Jordan Lapen (Baldwin Whitehall), 6-3",
        "5th Asher Morvay (North Hills) F Anthony Domino (West Mifflin), 2:37",
      ]},
      { wt: 138, placements: [
        "1st Hunter Nestor (North Hills) F Archie Collins (Montour), 2:05",
      ...
      { wt: 155, placements: [
        "1st Gavin McDowell (Avonworth) F Liam Mooney (Mt. Lebanon), 2:55",
      ...
      { wt: 170, placements: [
        ...
        "3rd Dominic Cisnero Torres (Carlynton) F Garett Huff (Plum), 1:38",
        "5th Achilles Anger-Youngblood (Highlands) F Donny Vogtsberger (Thomas Jefferson), 1:00",
      ]},
      { wt: 190, placements: [
        "1st Brennan Breisinger (Quaker Valley) DEC Cj Harris (North Hills), 7-0",
        "3rd Logan Thies (Highlands) F Matthew McGrail (Bethel Park), 1:28",
        "5th Maxsim Batman (Plum) DEC Garret Pollock (Thomas Jefferson), 6-0",
      ]},
      { wt: 210, placements: [
        "1st Ricky Herman (Montour) F Sami Tapu (Shaler Area), 3:12",
    ...
    teamStandings: [
      { rank: 1, team: "Thomas Jefferson", points: 259.5 },
      { rank: 2, team: "North Hills", points: 239 },
      { rank: 3, team: "Mt. Lebanon", points: 190.5 },
      { rank: 4, team: "Shaler Area", points: 173 },
      { rank: 5, team: "West Mifflin", points: 165.5 },
      { rank: 6, team: "Plum", points: 157 },
      { rank: 7, team: "Baldwin Whitehall", points: 139.5 },
      { rank: 8, team: "Moon Area", points: 135 },
      { rank: 9, team: "Montour", points: 127.5 },
      { rank: 10, team: "Avonworth", points: 126 },
      { rank: 11, team: "Fox Chapel", points: 122 },
      { rank: 12, team: "Highlands", points: 113.5 },
      { rank: 13, team: "Bethel Park", points: 108 },
      { rank: 14, team: "Gateway", points: 103.5 },
      { rank: 15, team: "Hampton", points: 100 },
      { rank: 16, team: "Quaker Valley", points: 94 },
      { rank: 17, team: "South Park", points: 90 },
      { rank: 18, team: "Upper Saint Clair", points: 83 },
      { rank: 19, team: "Riverview", points: 70 },
      { rank: 20, team: "Chartiers Valley", points: 62 },
      { rank: 21, team: "McKeesport", points: 42 },
      { rank: 22, team: "Woodland Hills", points: 39 },
      { rank: 23, team: "Carlynton", points: 32 },
      { rank: 24, team: "The Neighborhood Academy", points: 30 },
      { rank: 25, team: "South Allegheny", points: 23 },
      { rank: 26, team: "Penn Hills", points: 17 },
    ],
  },
];
